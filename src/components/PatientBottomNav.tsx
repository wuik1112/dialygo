...
export default function PatientBottomNav() {
  ...
  return (
    <div className='fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-md bg-white border-t border-slate-100 flex justify-around items-center pb-safe pt-2 px-2 shadow-[0_-4px_20px_rgba(0,0,0,0.02)] z-[100] h-[72px]'>
      {navItems.map((item) => {
